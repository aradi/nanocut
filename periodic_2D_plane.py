...
class periodic_2D_plane(body.body):
  ...
  def __init__(self,geometry,periodicity,thickness,shift_vector=numpy.array([0,0,0]),order=1,shift_vector_coordsys="lattice"):
  ...
  def _from_dict_helper(cls,geometry,args,periodicity):
    return cls(geometry,periodicity,args["thickness"],args["shift_vector"],args["order"],
